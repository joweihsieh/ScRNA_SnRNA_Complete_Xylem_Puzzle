...
# input_integrated_rds <- "results/Multi_species_analysis/all_data_rds/integration_Species5.rds"
...
# )
# colnames(plotting_df) <- c("UMAP.1", "UMAP.2")
# feature_sample_barcode <- strsplit(rownames(plotting_df), split = "_")

...
cluster_csv_path <- paste0(
    input_folder,
    "/outs/analysis/clustering/gene_expression_kmeans_", # kmeans_ for 5.0.1
    n_cluster,
...
umap_csv_path <- paste0(
    input_folder,
    "/outs/analysis/umap/gene_expression_2_components/projection.csv" # 2_components for 5.0.1
)

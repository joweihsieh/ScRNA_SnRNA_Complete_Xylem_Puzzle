...
setwd("/quobyte/bcmeyersgrp/jwahsieh/YCL/overlapping")
...
runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_scRNATung_ProtosnRNABio1_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds',
    prefix = 'scRNATung_ProtosnRNABio1',
    sp1 = "TenX_Ptr_",
    sp2 = "TenX_NucXyProtoBio1"
)
# 3hr

runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_scRNATung_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds',
    prefix = 'scRNATung_ProtosnRNABio2',
    sp1 = "TenX_Ptr_",
    sp2 = "TenX_NucXyProtoBio2"
)



# re-run uisng 600 GB memory
runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio2_ProtosnRNABio1_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds',
    prefix = 'snRNABio2_ProtosnRNABio1',
    sp1 = "TenX_NucXyBio2",
    sp2 = "TenX_NucXyProtoBio1"
)
...
# done
runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio3_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds',
    prefix = 'snRNABio3_ProtosnRNABio2',
    sp1 = "TenX_NucXyBio3",
    sp2 = "TenX_NucXyProtoBio2"
)
...
# re-run uisng 600 GB memory 
runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio3_ProtosnRNABio1_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds',
    prefix = 'snRNABio3_ProtosnRNABio1',
    sp1 = "TenX_NucXyBio3",
    sp2 = "TenX_NucXyProtoBio1"
)
...
runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio2_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds',
    prefix = 'snRNABio2_ProtosnRNABio2',
    sp1 = "TenX_NucXyBio2",
    sp2 = "TenX_NucXyProtoBio2"
)
...
##################### PtrTung vs ProtosnRNABio1  

ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_scRNATung_ProtosnRNABio1_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_scRNATung_ProtosnRNABio1_subtreeCenter.rds')
...
centerContourPlot(
    ...
    lowerPercentile = 5,
    higherPercentile = 40,
    main = 'scRNATung_ProtosnRNABio1',
    plot_name = 'scRNATung_ProtosnRNABio1',
    sp1 = "TenX_Ptr_"
    )


##################### PtrTung vs ProtosnRNABio2 

ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_scRNATung_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_scRNATung_ProtosnRNABio2_subtreeCenter.rds')
...
centerContourPlot(
    ...
    lowerPercentile = 5,
    higherPercentile = 40,
    main = 'scRNATung_ProtosnRNABio2',
    plot_name = 'scRNATung_ProtosnRNABio2',
    sp1 = "TenX_Ptr_"
    )


##################### snRNABio2 (Quanzi2) vs ProtosnRNABio1 

ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio2_ProtosnRNABio1_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_snRNABio2_ProtosnRNABio1_subtreeCenter.rds')
...
centerContourPlot(
    ...
    lowerPercentile = 5,
    higherPercentile = 40,
    main = 'snRNABio2_ProtosnRNABio1',
    plot_name = 'snRNABio2_ProtosnRNABio1',
    sp1 = "TenX_NucXyBio2_"
    )
...
##################### snRNABio3 (Quanzi3) vs ProtosnRNABio2 

ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio3_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_snRNABio3_ProtosnRNABio2_subtreeCenter.rds')
...
centerContourPlot(
    ...
    lowerPercentile = 5,
    higherPercentile = 40,
    main = 'snRNABio3_ProtosnRNABio2',
    plot_name = 'snRNABio3_ProtosnRNABio2',
    sp1 = "TenX_NucXyBio3_"
    )


##################### snRNABio3 (Quanzi3) vs ProtosnRNABio1 

ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio3_ProtosnRNABio1_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_snRNABio3_ProtosnRNABio1_subtreeCenter.rds')
...
centerContourPlot(
    ...
    lowerPercentile = 5,
    higherPercentile = 40,
    main = 'snRNABio3_ProtosnRNABio1',
    plot_name = 'snRNABio3_ProtosnRNABio1',
    sp1 = "TenX_NucXyBio3_"
    )


##################### snRNABio2 (Quanzi2) vs ProtosnRNABio2

ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio2_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_snRNABio2_ProtosnRNABio2_subtreeCenter.rds')
...
centerContourPlot(
    ...
    lowerPercentile = 5,
    higherPercentile = 40,
    main = 'snRNABio2_ProtosnRNABio2',
    plot_name = 'snRNABio2_ProtosnRNABio2',
    sp1 = "TenX_NucXyBio2_"
    )
...
centerContourPlot_pie(
    ...
    plot_name = 'scRNATung_ProtosnRNABio1',
    sp1 = "TenX_Ptr_",
    df_path = paste0('Overlap_heatpie_', "scRNATung_ProtosnRNABio1", '_on_scRNATung.csv')
    )


ovelaps <- read.csv("Overlap_heatpie_scRNATung_ProtosnRNABio1_on_scRNATung.csv")
...
centerContourPlot_pie(
    ...
    plot_name = 'scRNATung_ProtosnRNABio2',
    sp1 = "TenX_Ptr_",
    df_path = paste0('Overlap_heatpie_', "scRNATung_ProtosnRNABio2", '_on_scRNATung.csv')
    )
...
ovelaps <- read.csv("Overlap_heatpie_scRNATung_ProtosnRNABio2_on_scRNATung.csv")
percent <- (sum(ovelaps$col_counts)-(ovelaps[ovelaps$filled_col=="#B4D1EA","col_counts"]))/sum(ovelaps$col_counts)*100
print(percent)
##################### snRNABio2 vs ProtosnRNABio1
...
centerContourPlot_pie(
    ...
    plot_name = 'snRNABio2_ProtosnRNABio1',
    sp1 = "TenX_NucXyBio2_",
    df_path = paste0('Overlap_heatpie_', "snRNABio2_ProtosnRNABio1", '_on_snRNABio2.csv')
    )
...
ovelaps <- read.csv("Overlap_heatpie_snRNABio2_ProtosnRNABio1_on_snRNABio2.csv")
percent <- (sum(ovelaps$col_counts)-(ovelaps[ovelaps$filled_col=="#B4D1EA","col_counts"]))/sum(ovelaps$col_counts)*100
percent
##################### snRNABio3 vs ProtosnRNABio2
...
centerContourPlot_pie(
    ...
    plot_name = 'snRNABio3_ProtosnRNABio2',
    sp1 = "TenX_NucXyBio3_",
    df_path = paste0('Overlap_heatpie_', "snRNABio3_ProtosnRNABio2", '_on_snRNABio3.csv')
    )
...
ovelaps <- read.csv("Overlap_heatpie_snRNABio3_ProtosnRNABio2_on_snRNABio3.csv")
percent <- (sum(ovelaps$col_counts)-(ovelaps[ovelaps$filled_col=="#B4D1EA","col_counts"]))/sum(ovelaps$col_counts)*100
percent

##################### snRNABio3 vs ProtosnRNABio1 
...
centerContourPlot_pie(
    ...
    plot_name = 'snRNABio3_ProtosnRNABio1',
    sp1 = "TenX_NucXyBio3_",
    df_path = paste0('Overlap_heatpie_', "snRNABio3_ProtosnRNABio1", '_on_snRNABio3.csv')
    )
...
ovelaps <- read.csv("Overlap_heatpie_snRNABio3_ProtosnRNABio1_on_snRNABio3.csv")
percent <- (sum(ovelaps$col_counts)-(ovelaps[ovelaps$filled_col=="#B4D1EA","col_counts"]))/sum(ovelaps$col_counts)*100
percent
##################### snRNABio2 vs ProtosnRNABio2
ClaPAIR_projectionUMAP = runUMAPandSaveSubtreeCenter(
    rdsFilePath = 'integration_snRNABio2_ProtosnRNABio2_an_2000_ft_200_kan_5_seed_42_md_0.3_nn_30_base.rds')
ClaPAIR_subtreeCenter = readRDS('RDS_snRNABio2_ProtosnRNABio2_subtreeCenter.rds')
...
centerContourPlot_pie(
    ...
    plot_name = 'snRNABio2_ProtosnRNABio2',
    sp1 = "TenX_NucXyBio2_",
    df_path = paste0('Overlap_heatpie_', "snRNABio2_ProtosnRNABio2", '_on_snRNABio2.csv')
    )
...
ovelaps <- read.csv("Overlap_heatpie_snRNABio2_ProtosnRNABio2_on_snRNABio2.csv")
percent <- (sum(ovelaps$col_counts)-(ovelaps[ovelaps$filled_col=="#B4D1EA","col_counts"]))/sum(ovelaps$col_counts)*100
percent

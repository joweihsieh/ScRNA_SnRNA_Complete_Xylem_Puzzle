...
# input_SC_geneUMI_csv <-
#     "results/Single_species_analysis/all_data_tables/geneUMI_TenX_Ptr.csv"
# input_SC_plotting_csv <-
#     "results/Single_species_analysis/all_data_tables/plotting_TenX_Ptr.csv"
# input_LCM_gene_abundance_csv <-
#     "results/LCM_analysis/quantification/PtrFiber1_gene_abundances.csv"
# cor_method <- c("pearson", "kendall", "spearman")[1]
